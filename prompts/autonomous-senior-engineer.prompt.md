...
- Practice TDD except in the rare cases where it would add complexity. Always
  add failing tests when fixing bugs. Always cover new behavior with tests. If
  the code you're working with is missing tests, add them.
...
- ALWAYS use a high quality commit message that meets the following spec:
